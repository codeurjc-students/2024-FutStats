...
public class RestService {
    ...
    public List<PlayerMatch> findAllPlayerMatchesByPlayer(long id) {
        return playerMatchRepository.findAllByPlayer(id);
    }

    public List<PlayerMatch> findAllPlayerMatchesByMatch(long id) {
        return playerMatchRepository.findAllByMatch(id);
    }
    ...
    public List<Match> findMatchesByLeague(League league) {
        return matchRepository.findAllByLeague(league.getId());
    }
